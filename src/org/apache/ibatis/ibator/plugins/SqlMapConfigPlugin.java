...
public class SqlMapConfigPlugin extends IbatorPluginAdapter {
	...
	public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles() {
		...
		settings.addAttribute(new Attribute("errorTracingEnabled", "true"));// 是否启用错误日志，在开发期间建议设为"true"以方便调试。默认值为“false”
		settings.addAttribute(new Attribute("lazyLoadingEnabled", "true"));// 是否启用延迟加载机制，建议设为"true"。默认值为“tue”
