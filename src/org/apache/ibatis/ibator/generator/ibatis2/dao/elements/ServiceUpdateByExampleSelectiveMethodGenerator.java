 ...
 *
 */
public class ServiceUpdateByExampleSelectiveMethodGenerator extends AbstractDAOElementGenerator {
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("return " + daoName + ".updateByExampleSelective(" + method.getParameters().get(0).getName() + ", " + method.getParameters().get(1).getName() + ");");
