 ...
 *
 */
public class ServiceSelectByExampleWithoutBLOBsMethodGenerator extends AbstractDAOElementGenerator {

	private boolean generateForJava5;

	public ServiceSelectByExampleWithoutBLOBsMethodGenerator(boolean generateForJava5) {
		super();
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("return " + daoName + "."+method.getName()+"(" + method.getParameters().get(0).getName() + ");");
