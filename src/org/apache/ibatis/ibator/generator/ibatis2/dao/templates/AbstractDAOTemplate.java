...
public abstract class AbstractDAOTemplate {
	 ...
	 * Subclasses should implement the individual configureXXX methods to setup the
	 * relevant parts of the DAO template (super class, extra methods, etc.) that
	 * are relevant for this specific type of DAO.
	 */
	...
	/**
	 * Override this method to add checked exceptions to the throws clause of any
	 * generated DAO method. When overriding this method, call
	 * <code>addCheckedException(FullyQualifiedJavaType)</code> one or more times to
	 * add checked exception(s) to all generated DAO methods.
	 */
	 ...
	 * When overriding this method, call <code>addField(Field)</code> one or more
	 * times to add field(s) to the generated DAO implementation class.
	 */
	...
	/**
	 * Override this method to add imports to generated DAO interface classes. When
	 * overriding this method, call
	 * <code>addInterfaceImport(FullyQualifiedJavaType)</code> one or more times to
	 * add import(s) to generated DAO interface classes.
	 */
	 ...
	 * When overriding this method, call <code>addMethod(Method)</code> one or more
	 * times to add method(s) to generated DAO implementation classes.
	 */
	 ...
	 * <code>setSuperClass(FullyQualifiedJavaType)</code> to set the superclass for
	 * generated DAO implementation classes.
	 */
	 ...
	 * implementation classes. During code generation, Ibator will build a new
	 * constructor using the visibility, parameters, body lines, and exceptions set
	 * on the constructor template. When overriding this method, call
	 * <code>setConstructorTemplate(Method)</code> to set the constructor template.
	 */
	protected abstract void configureConstructorTemplate();

	/**
	 * Override this method to configure an insert method template. A method
	 * template is a string with three substitution markers that Ibator will fill in
	 ...
	 * </ul>
	 * 
	 * For example, when calling methods in the SqlMapClient interface, the template
	 * would be:
	 * 
	...
	/**
	 * Override this method to configure a queryForList method template. A method
	 * template is a string with three substitution markers that Ibator will fill in
	 * when generating code. The substitution markers will be:
	 * <ul>
	 * <li>{0} - The SqlMap namespace</li>
	...
	/**
	 * Override this method to configure a queryForObject method template. A method
	 * template is a string with three substitution markers that Ibator will fill in
	 * when generating code. The substitution markers will be:
	 * <ul>
	 * <li>{0} - The SqlMap namespace</li>
	...
	/**
	 * Override this method to configure a delete method template. A method template
	 * is a string with three substitution markers that Ibator will fill in when
	 * generating code. The substitution markers will be:
	 * <ul>
	 * <li>{0} - The SqlMap namespace</li>
	 * <li>{1} - The SqlMap statement id</li>
	 * <li>{2} - The parameter object</li>
