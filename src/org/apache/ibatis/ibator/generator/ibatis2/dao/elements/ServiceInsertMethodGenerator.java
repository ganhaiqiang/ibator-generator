 ...
 *
 */
public class ServiceInsertMethodGenerator extends AbstractDAOElementGenerator {

	public ServiceInsertMethodGenerator() {
		super();
	}
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		method.addBodyLine(daoName + ".insert(" + method.getParameters().get(0).getName() + ");");
