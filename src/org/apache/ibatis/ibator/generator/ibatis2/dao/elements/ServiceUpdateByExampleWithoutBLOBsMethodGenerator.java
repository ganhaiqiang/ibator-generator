 ...
 *
 */
public class ServiceUpdateByExampleWithoutBLOBsMethodGenerator extends AbstractDAOElementGenerator {

	public ServiceUpdateByExampleWithoutBLOBsMethodGenerator() {
		super();
	}
