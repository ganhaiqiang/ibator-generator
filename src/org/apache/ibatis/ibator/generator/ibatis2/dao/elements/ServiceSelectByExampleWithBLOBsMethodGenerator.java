 ...
 *
 */
public class ServiceSelectByExampleWithBLOBsMethodGenerator extends AbstractDAOElementGenerator {

	private boolean generateForJava5;

	public ServiceSelectByExampleWithBLOBsMethodGenerator(boolean generateForJava5) {
		super();
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("return " + daoName + ".selectByExampleWithBLOBs(" + method.getParameters().get(0).getName() + ");");
