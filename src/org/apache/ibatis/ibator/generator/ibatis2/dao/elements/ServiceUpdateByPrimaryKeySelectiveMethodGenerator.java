 ...
 *
 */
public class ServiceUpdateByPrimaryKeySelectiveMethodGenerator extends AbstractDAOElementGenerator {

	public ServiceUpdateByPrimaryKeySelectiveMethodGenerator() {
		super();
	}
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("return " + daoName + ".updateByPrimaryKeySelective(" + method.getParameters().get(0).getName() + ");");
