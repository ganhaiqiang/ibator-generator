 ...
 *
 */
public class ServiceDeleteByExampleMethodGenerator extends AbstractDAOElementGenerator {

	public ServiceDeleteByExampleMethodGenerator() {
		super();
	}
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("return " + daoName + ".deleteByExample(" + method.getParameters().get(0).getName() + ");"); //$NON-NLS-1$
