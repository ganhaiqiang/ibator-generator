 ...
 *
 */
public class ServiceUpdateByPrimaryKeyWithBLOBsMethodGenerator extends AbstractDAOElementGenerator {

	public ServiceUpdateByPrimaryKeyWithBLOBsMethodGenerator() {
		super();
	}
