 ...
 *
 */
public class ServiceUpdateByPrimaryKeyWithoutBLOBsMethodGenerator extends AbstractDAOElementGenerator {

	public ServiceUpdateByPrimaryKeyWithoutBLOBsMethodGenerator() {
		super();
	}
